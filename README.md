...
<head>
    ...
    <title>인터랙티브 QA 프로세스</title>
    <script src="https://cdn.tailwindcss.com"></script>
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Noto+Sans+KR:wght@300;400;500;700&display=swap" rel="stylesheet">
    <!-- Chosen Palette: Calm Harmony -->
    <!-- Application Structure Plan: A central, interactive process flow diagram acts as the primary navigation. Clicking a stage in the flow dynamically displays its detailed content below. This transforms the static, linear document into an explorable, non-linear experience, breaking down information into manageable parts for better user comprehension and engagement. -->
    <!-- Visualization & Content Choices: The core QA process is visualized as an interactive, clickable flowchart using HTML/CSS/JS, as it's the most intuitive way to represent and navigate a sequence. Detailed text content for each stage is presented in dynamically appearing cards to maintain focus and reduce cognitive load. This avoids static text walls and requires no charting libraries as the data is qualitative. -->
